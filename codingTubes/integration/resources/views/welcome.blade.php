        ...
        <div class="row align-items-start align-items-md-center justify-content-end">
          <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
            ...
            <div class="intro-text text-center text-md-left">
              ...
              <p>
                <a href="#" class="btn btn-sm btn-primary">Cari sekarang!</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
            <a class="block-2-item" href="#">
              <figure class="image">
                <img src="templateHome/images/women.jpg" alt="" class="img-fluid">
              </figure>
              <div class="text">
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <a class="block-2-item" href="#">
              <figure class="image">
                <img src="templateHome/images/children.jpg" alt="" class="img-fluid">
              </figure>
              <div class="text">
                <span class="text-uppercase">Collections</span>
                <h3>Children</h3>
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
            <a class="block-2-item" href="#">
              <figure class="image">
                <img src="templateHome/images/men.jpg" alt="" class="img-fluid">
              </figure>
              <div class="text">
                <span class="text-uppercase">Collections</span>
                <h3>Men</h3>
          ...
          <div class="col-md-12">
            <div class="nonloop-block-3 owl-carousel">
              <div class="item">
                <div class="block-4 text-center">
                  <figure class="block-4-image">
                    <img src="templateHome/images/cloth_1.jpg" alt="Image placeholder" class="img-fluid">
                  </figure>
              ...
              <div class="item">
                <div class="block-4 text-center">
                  <figure class="block-4-image">
                    <img src="templateHome/images/shoe_1.jpg" alt="Image placeholder" class="img-fluid">
                  </figure>
                  <div class="block-4-text p-4">
              ...
              <div class="item">
                <div class="block-4 text-center">
                  <figure class="block-4-image">
                    <img src="templateHome/images/cloth_2.jpg" alt="Image placeholder" class="img-fluid">
                  </figure>
                  <div class="block-4-text p-4">
              ...
              <div class="item">
                <div class="block-4 text-center">
                  <figure class="block-4-image">
                    <img src="templateHome/images/cloth_3.jpg" alt="Image placeholder" class="img-fluid">
                  </figure>
                  <div class="block-4-text p-4">
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 mb-5">
            <a href="#"><img src="templateHome/images/blog_1.jpg" alt="Image placeholder" class="img-fluid rounded"></a>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
            ...
            <a href="#" class="block-6">
              <img src="templateHome/images/hero_1.jpg" alt="Image placeholder" class="img-fluid rounded mb-4">
